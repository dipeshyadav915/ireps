...
const ArchiveMainTender = sequelize.define(
  'ArchiveMainTender',
  {
    fld_id: {
    ...
    status: {
      type: DataTypes.NUMBER, // Status is likely a string (e.g., 'active', 'inactive')
      allowNull: true,
    },
    entry_date: {
      type: DataTypes.DATE, // Adjust if the format is different (e.g., STRING)
  ...
  {
    tableName: 'archive_tg_main_tender', // The table name in your database
    timestamps: false, // Assuming no timestamps like createdAt/updatedAt are being used
  },
);

module.exports = ArchiveMainTender;
