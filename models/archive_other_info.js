...
const ArchiveTenderOtherInfo = sequelize.define(
  'ArchiveTenderOtherInfo',
  {
    fld_id: {
  ...
  {
    tableName: 'archive_tg_main_tender_otherinfo', // The table name in the database
    timestamps: false, // No timestamps like `createdAt`, `updatedAt`
  },
);

module.exports = ArchiveTenderOtherInfo;
